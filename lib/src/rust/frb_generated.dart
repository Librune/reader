...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 230029299;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'rust_lib_reader',
...
abstract class RustLibApi extends BaseApi {
  int crateApiSimpleAdd({required int num1, required int num2});

  Future<String> crateApiSimpleAsyncGreeting({required String name});

  Future<String> crateApiSimpleFetchBaidu();
  ...
  String crateApiEcmaJsGetAttribute(
      {required String uuid, required String key});
  ...
  void crateApiEnvsSetEnv(
      {required String uuid, required Map<String, String> value});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  int crateApiSimpleAdd({required int num1, required int num2}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_i_8(num1, serializer);
        sse_encode_i_8(num2, serializer);
  ...
  TaskConstMeta get kCrateApiSimpleAddConstMeta => const TaskConstMeta(
        debugName: "add",
        argNames: ["num1", "num2"],
      );
  ...
  Future<String> crateApiSimpleAsyncGreeting({required String name}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSimpleAsyncGreetingConstMeta,
      argValues: [name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleAsyncGreetingConstMeta =>
      const TaskConstMeta(
        debugName: "async_greeting",
        argNames: ["name"],
      );
  ...
  Future<String> crateApiSimpleFetchBaidu() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSimpleFetchBaiduConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleFetchBaiduConstMeta => const TaskConstMeta(
        debugName: "fetch_baidu",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiEnvsGetEnvConstMeta => const TaskConstMeta(
        debugName: "get_env",
        argNames: ["uuid"],
      );
  ...
  TaskConstMeta get kCrateApiEcmaGetUuidConstMeta => const TaskConstMeta(
        debugName: "get_uuid",
        argNames: ["code"],
      );
  ...
  TaskConstMeta get kCrateApiEcmaInitJsScriptsConstMeta => const TaskConstMeta(
        debugName: "init_js_scripts",
        argNames: ["scripts"],
      );

  @override
  void crateApiEcmaInsertJsScript(
      {required String uuid, required String code}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(uuid, serializer);
  ...
  TaskConstMeta get kCrateApiEcmaJsEvalConstMeta => const TaskConstMeta(
        debugName: "js_eval",
        argNames: ["code"],
      );
  ...
  TaskConstMeta get kCrateApiEcmaJsEvalAsyncConstMeta => const TaskConstMeta(
        debugName: "js_eval_async",
        argNames: ["code"],
      );
  ...
  TaskConstMeta get kCrateApiEcmaJsEvalAutoConstMeta => const TaskConstMeta(
        debugName: "js_eval_auto",
        argNames: ["code"],
      );
  ...
  TaskConstMeta get kCrateApiEcmaRemoveJsScriptConstMeta => const TaskConstMeta(
        debugName: "remove_js_script",
        argNames: ["uuid"],
      );
  ...
  TaskConstMeta get kCrateApiEnvsSetEnvConstMeta => const TaskConstMeta(
        debugName: "set_env",
        argNames: ["uuid", "value"],
      );
