  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Material(
      color: Color.alphaBlend(
        coverScheme.data!.surfaceContainerLow.withAlpha(160),
        coverScheme.data!.surfaceContainerLowest,
      ),
      child: Column(
        children: [
          SizedBox(
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text("云峰",
                        style: TextStyle(fontSize: 16, color: coverScheme.data?.secondary.withAlpha(180), height: 2)),
                  ],
                ),
                Spacer(),
                SvgBtn(
          ...
          Row(
            ...
            children: [
              SvgPicture.asset(
                ...
                colorFilter: ColorFilter.mode(coverScheme.data!.secondary.withAlpha(180), BlendMode.srcIn),
                width: 20,
              ),
              Padding(
                ...
                child: Text(
                  "向左滑动开始阅读",
                  style: TextStyle(color: coverScheme.data!.secondary.withAlpha(180), height: 1),
                ),
              )
            ],
          ),
