...
class BookDetailScreen extends HookConsumerWidget {
  const BookDetailScreen(
      {super.key, required this.book, required this.uuid, required this.bid});
  final String uuid;
  final String bid;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final data = coverColorScheme.data!;
    return Material(
        color: Color.alphaBlend(
            coverColorScheme.data!.primary.withAlpha(50), Colors.black),
