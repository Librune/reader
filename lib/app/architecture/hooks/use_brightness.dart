...
void useBrightness(BuildContext context, {required bool autoDarkMode, required bool isDarkMode}) {
  late final Brightness statusbarColor;
  bool isIOS = Platform.isIOS;
  if (autoDarkMode) {
    statusbarColor = Theme.of(context).brightness == (isIOS ? Brightness.light : Brightness.dark)
        ? Brightness.light
        : Brightness.dark;
  } else {
