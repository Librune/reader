        ...
        for (
          ...
          o.length &&
            (void 0 !== r[s][4]
              ...
              : e.allowBooleanAttributes && (i[e.attributeNamePrefix + o] = !0))
        }
      ...
      for (var r = new i('!xml'), s = r, d = '', c = 0; c < t.length; c++) {
        if ('<' === t[c])
          if ('/' === t[c + 1]) {
            ...
            c = t.substring(c, b).indexOf('[') >= 0 ? t.indexOf(']>', c) + 1 : b
    ...
    function f(t, e) {
      for (var r = a.getAllMatches(t, c), n = {}, i = 0; i < r.length; i++) {
        ...
        if (n.hasOwnProperty(s))
          return g('InvalidAttr', "Attribute '" + s + "' is repeated.", m(r[i]))
        n[s] = 1
      }
      return !0
    }
  ...
  function (t, e, r) {
    ...
    function l(t, e) {
      if (
        ...
        return t + '<![CDATA[' + e.join(']]><![CDATA[') + ']]' + this.tagEndChar
      for (var r in e)
        t = t.replace(
          this.options.cdataPositionChar,
          '<![CDATA[' + e[r] + ']]>'
    ...
    ;(s.prototype.parse = function (t) {
      ...
      (s.prototype.j2x = function (t, e) {
        ...
        for (var n in t)
          ...
          else if (t[n] instanceof Date) a += this.buildTextNode(t[n], n, '', e)
